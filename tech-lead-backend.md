# Tech Lead Backend na V3

Estamos contratando um Tech Lead para se juntar a V3 e liderar uma de nossas equipes com foco na construção dos sistemas Back-end.
...
Sua missão será **compreender**, **avaliar** e **evoluir** os nossos sistemas utilizando as melhores práticas de mercado para a linguagem GO. Além de ser um **líder** que **inspira** e **motiva** o time!

Procuramos alguém com **experiência** em **desenvolvimento GO** e na **liderança de equipes**!
